...
class Generator:
    def __init__(self, input_z, input_rnn, is_training, reuse):
        self.input_z = input_z    # Noise
        self.input_rnn = input_rnn
        self.is_training = is_training
        self.reuse = reuse
        self.t_dim = 128     #Text feature dimension
        self.gf_dim = 128    #Number of conv in the first layer generator
        self.image_size = 64 #64 X 64
        self.c_dim = 3       #RGB
        self._build_model()
