...
def IdList2sent(caption):
    """
        Transform the id list into a complete sentence.
    """
    sentence = []
    for ID in caption:
...
# Data Augmentation reference: https://github.com/tensorlayer/tensorlayer/blob/374180a0cd380b9b98215efe40eec5f8e6f3c45e/tensorlayer/prepro.py
